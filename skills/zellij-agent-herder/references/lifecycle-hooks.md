...
After installation, restart the host, verify pane titles transition during a request, make a harmless file change, and confirm the review stream appears beside the recorded origin when placement permits.
